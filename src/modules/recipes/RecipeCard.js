...
const RecipeCard = ({
  ...
  <Box
    ...
    <Box borderRadius="2px 2px 0px 0px" paddingBottom="56.25%" overflow="hidden" height="0">
      <img src={image} alt={name} width="100%" data-testid="recipe-image" />
    </Box>

    <Box p="xs" height="120px">
      <Text fontWeight="bold" fontFamily="primary" fontSize="md" data-testid="recipe-name">
        {name}
      </Text>
      <Text fontWeight="regular" fontFamily="secondary" fontSize="sm" data-testid="recipe-headline">
        {headline}
      </Text>
    </Box>
    {selected ? (
...
const UnselectedRecipeFooter = ({
  ...
  <Flex p="xs">
    <Box flex="50%" alignSelf="center" data-testid="recipe-extra-charge">
...
const SelectedRecipeFooter = ({
  ...
  <Flex backgroundColor="primary_600" justifyContent="space-between" alignItems="center">
    <SelectionButton
      ...
      data-testid="button-remove-recipe">
      <IconMinusCircle />
    </SelectionButton>
    <Box color="white">
      <Text
        ...
        fontSize="md"
        data-testid="recipe-selected-count">
        {selected} in your box
      </Text>
      <Text textAlign="center" fontFamily="secondary" fontSize="sm" data-testid="recipe-yields">
    ...
    <SelectionButton
      ...
      disabled={maxRecipesSelected || (selectionLimit && selectionLimit <= selected)}
      data-testid="button-add-recipe">
      <IconPlusCircle />
    </SelectionButton>
  </Flex>
